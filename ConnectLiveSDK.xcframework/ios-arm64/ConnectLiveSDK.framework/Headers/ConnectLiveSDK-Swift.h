...
#ifndef CONNECTLIVESDK_SWIFT_H
#define CONNECTLIVESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ConnectLiveSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// 오디오세션 이벤트
SWIFT_PROTOCOL("_TtP14ConnectLiveSDK20AudioSessionDelegate_")
@protocol AudioSessionDelegate
@optional
/// 오디오세션 인터럽트
- (void)didBeginInterruption;
/// 오디오세션 인터럽트 해제
...
/// 오디오세션 입출력 옵션 변경
- (void)didChangeCanPlayOrRecordWithCanPlayOrRecord:(BOOL)canPlayOrRecord;
/// 오디오세션 입출력 시작
- (void)didStartPlayOrRecord;
- (void)didStopPlayOrRecord;
/// 오디오세션 활성화 이벤트
